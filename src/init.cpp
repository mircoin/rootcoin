...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 33813 or testnet: 8292)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 33812 or testnet: 8473)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Rootcoin Wiki for SSL setup instructions)") + "\n" +
